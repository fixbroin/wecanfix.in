...
export const heroSlides = [
  { id: 'slide1', title: 'Flat 20% Off', description: 'On your first Home Cleaning service. Book Now!', imageUrl: '/default-image.png', imageHint: 'clean home offer', buttonText: 'Book Cleaning', buttonLink: '/category/cleaning-services' }, // Updated link to general category
  { id: 'slide2', title: 'Expert AC Repair', description: 'Starting at just ₹499. Keep cool this summer!', imageUrl: '/default-image.png', imageHint: 'ac repair technician', buttonText: 'Book AC Service', buttonLink: '/category/appliance-repair' }, // Updated link
  { id: 'slide3', title: 'Quick Plumbing Solutions', description: 'Leaky pipes? We fix it all. Fast and reliable.', imageUrl: '/default-image.png', imageHint: 'plumber working tools', buttonText: 'Get Plumbing Help', buttonLink: '/category/home-repairs' }, // Updated link
];
