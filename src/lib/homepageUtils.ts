...
export async function getCategoryFullData(categorySlug: string): Promise<FullCategoryData | null> {
    try {
...
export async function getAggregateRating(): Promise<{ ratingValue: string, reviewCount: number } | null> {
    try {
