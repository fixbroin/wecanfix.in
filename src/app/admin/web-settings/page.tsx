...
import { Textarea } from "@/components/ui/textarea"; // Will be replaced by Editor for content
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (!document.getElementById(scriptId)) {
        ...
        script.onerror = () => {
          toast({ title: "Editor Error", description: "Could not load the rich text editor.", variant: "destructive" });
        };
        ...
        if ((window as any).tinymce) {
          ...
          if (existingScript.onload === null) { 
            ...
            existingScript.onerror = () => {
                 toast({ title: "Editor Error", description: "Could not load the rich text editor (existing script).", variant: "destructive" });
            };
          }
        }
      }
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                {selectedPageSlug && (
                    ...
                    <form onSubmit={contentPageForm.handleSubmit(handleSaveContentPage)} className="space-y-4">
                                    ...
                                    <Editor
                                      ...
                                      init={{
                                        ...
                                        plugins: [
                                          ...
                                          'autoresize', 'directionality', 'visualchars'
                                        ],
                                        toolbar:
                                          'undo redo | blocks | ' +
                                        ...
                                        images_upload_handler: (blobInfo, progress) => new Promise((resolve, reject) => {
                                            toast({
                                                ...
                                                description: "Direct image uploads are not configured. Please host your image and use the 'Insert/edit image' by URL option.",
                                                variant: "destructive",
                                                duration: 7000,
                                            });
                                            reject('Image uploads are not configured on the server. Please use image URLs.');
                                        }),
                                      }}
                                      onEditorChange={(content) => {
                                        field.onChange(content);
                                      }}
                                      disabled={isSavingContent || !tinymceLoaded}
                                    />
                                  ) : (
                        ...
                        <Button type="submit" disabled={isSavingContent || !tinymceLoaded}>
