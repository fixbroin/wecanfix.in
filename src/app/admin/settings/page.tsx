...
import { Settings, DollarSign, CreditCard, Clock, Save, Loader2, AlertCircle, Map, MailIcon, PlaySquare, Percent, Ban } from "lucide-react"; // Added Ban for Cancellation
...
export default function AdminSettingsPage() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    setSettings(prev => {
      ...
      } else if (['carouselAutoplayDelay', 'visitingChargeTaxPercent', 'minimumBookingAmount', 'visitingChargeAmount', 'limitLateBookingHours', 'freeCancellationDays', 'freeCancellationHours', 'freeCancellationMinutes', 'cancellationFeeValue'].includes(name)) {
