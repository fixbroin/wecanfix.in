...
import { Search, Bell, Menu, X, ShoppingCart, LogOut, UserCircle, Briefcase, Settings2, Moon, Sun, MessageSquare, UserPlus, MapPin as AddressIcon, Construction } from 'lucide-react'; // Added Construction
                  ...
                  <ScrollArea className="flex-grow">
                    <nav className="flex flex-col gap-1 p-4">
                      ...
                      { !isLoadingFeaturesConfig && featuresConfig.showCustomServiceButton && (
                        <NavLink href="/custom-service" onClick={(e) => handleAuthRequiredNav(e, "/custom-service")}>
                          <Construction className="mr-2 inline-block h-4 w-4" /> Custom Service
                        </NavLink>
                      )}
