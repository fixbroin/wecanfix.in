...
const AppLayout: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  useEffect(() => {
    if (isClientMounted) { 
      ...
      const bottomNavActivePaths = ['/', '/chat', '/my-bookings', '/notifications', '/profile', '/checkout/schedule', '/custom-service','/checkout/address', '/checkout/payment', '/checkout/thank-you', '/cart', '/categories'];
  ...
  const bottomNavActivePaths = ['/', '/chat', '/notifications', '/my-bookings', '/profile', '/checkout/schedule', '/checkout/address', '/custom-service','/checkout/payment', '/checkout/thank-you', '/cart', '/categories'];
