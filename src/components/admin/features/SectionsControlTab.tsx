...
import { Loader2, Save, LayoutGrid, Star, Clock, ListChecks } from "lucide-react"; // Added ListChecks
...
const defaultFeaturesConfig: Pick<FeaturesConfiguration, 'showMostPopularServices' | 'showRecentlyAddedServices' | 'showCategoryWiseServices'> = {
