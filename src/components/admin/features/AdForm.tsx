...
const isFirebaseStorageUrl = (url: string | null | undefined): boolean => !!url && typeof url === 'string' && url.includes("firebasestorage.googleapis.com/v0/b/wecanfixweb.firebasestorage.app/o/public%2Fuploads%2Fads");
