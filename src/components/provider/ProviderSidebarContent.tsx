...
import { LayoutDashboard, UserCog, Settings, Briefcase, ListOrdered, DollarSign, Star, Bell } from 'lucide-react'; // Added Bell
...
const navItems = [
  ...
  { href: '/provider/notifications', label: 'Notifications', icon: Bell }, // Added Notifications link
  // Add more provider-specific links here as needed
];
